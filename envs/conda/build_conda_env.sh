...
#
# This script builds a Conda environment based on the provided name or the default 'ts-scaler'.
#
# Parameters:
#   -c, --conda_env       Specifies the name of the Conda environment (default: 'ts-scaler')
#
# Examples:
#   1. Build the default Conda environment 'ts-scaler':
#       ./build_conda_env.sh
#
